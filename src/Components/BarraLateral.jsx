...
const BarraLateral = () => {
  return (
    <div>
        <sidebar className="flex flex-col justify-between gap-8 bg-gray-100 min-h-screen max-h-screen w-80 p-4 overflow-y-scroll">
  <section>
    <div className="logo flex items-center gap-4 mb-8">
      ...
      />
      <div>
        <h3 className="font-bold text-indigo-600">jtdev</h3>
