    ...
    if (click) {
      ...
      switch (accion) {
        ...
        case 2: {
          let valor = await GetIsPermitido(accion, value);
          if (valor) {
            await Delete(["Compra", "Cheque"], value, setEliminar);
          }
          break;
        }
        case 3: {
        ...
        case 5: {
          let row = document
            .querySelector("#tablaCheque")
            .querySelector("tr.selected-row");
          if (row != null) {
            let id = row.children[0].innerHTML;
            await Imprimir(["Compra", "Cheque"], id);
          } else {
      ...
      {visible ? (
        <>
           <div className={G.ContenedorPadre}>
            <h2 className={G.TituloH2}>Programación de Cheques</h2>
